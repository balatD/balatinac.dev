...
const TechStackSlider = () => {
    return (
        <div>
            <div className='border-b border-grey/[.55] relative flex overflow-x-hidden gap-10 pt-10 pb-10 [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]'>
